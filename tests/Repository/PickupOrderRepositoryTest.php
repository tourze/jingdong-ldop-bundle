...
class PickupOrderRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // 构造Repository并注入模拟对象
        $this->repository = new PickupOrderRepository($this->registryMock);
    }
    ...
    {
        // 使用反射获取构造函数中使用的实体类名
        $reflection = new \ReflectionClass(PickupOrderRepository::class);
        ...
        $repository = new PickupOrderRepository($this->registryMock);
        $this->assertInstanceOf(PickupOrderRepository::class, $repository);
    }
} 